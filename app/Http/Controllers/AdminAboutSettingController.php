...
use Illuminate\Support\Facades\Storage;
	...
	class AdminAboutSettingController extends \crocodicstudio\crudbooster\controllers\CBController {

		public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->module_name = "About Setting";
		...
		public function getIndex(){
			...
			$data['page_title'] = 'About Setting';

			return view('vendor/crudbooster/about_setting', $data);
    ...
    {
        $this->return_url = url('admin/about_setting');
    }
