<?php namespace App\Http\Controllers;
	...
	class AdminBannersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Picture','name'=>'picture','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'Size: 1121 x 686px ,File types support : JPG, JPEG, PNG, GIF, BMP. '];
			$this->form[] = ['label'=>'Link','name'=>'link','type'=>'text','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Type','name'=>'type','type'=>'select','width'=>'col-sm-9','dataenum'=>'Home;Maag Meter','validation'=>'required'];
