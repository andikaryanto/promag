...
use Illuminate\Support\Facades\Storage;
	...
	class AdminPrivacyController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->module_name = "Privacy Policy Setting";
		...
		public function getIndex(){
			...
			$data['page_title'] = 'Privacy Policy Setting';

			return view('vendor/crudbooster/privacy_policy_setting', $data);
    ...
    {
        $this->return_url = url('admin/privacy');
    }
    ...
    function postSaveSetting()
    {
        ...
        foreach ($setting as $set) {
			...
			DB::table('cms_settings')->where('name', $set->name)
								->where('group_setting',$group)
