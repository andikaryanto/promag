...
use Illuminate\Support\Facades\Storage;
	...
	class AdminVideoSettingController extends \crocodicstudio\crudbooster\controllers\CBController {

		public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->module_name = "Video Setting";
		...
		public function getIndex(){
			...
			$data['page_title'] = 'Video Setting';

			return view('vendor/crudbooster/video_setting', $data);
    ...
    {
        $this->return_url = url('admin/video_setting');
    }
