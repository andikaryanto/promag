...
use Illuminate\Support\Facades\Storage;
	class AdminTermController extends \crocodicstudio\crudbooster\controllers\CBController {

		public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->module_name = "TAC Setting";
		...
		public function getIndex(){
			...
			$data['page_title'] = 'TAC Setting';

			return view('vendor/crudbooster/tac_setting', $data);
    ...
    {
        $this->return_url = url('admin/term');
    }
