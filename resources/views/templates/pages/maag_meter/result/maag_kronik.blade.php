		...
		<div class="container">
			<div class="row">
				<div class="col-12 d-flex justify-content-center">
					<h3 class="title-about my-5 text-uppercase" style="color: #42007c">
						Result
					</h3>
				</div>
			</div>
...
<div class="container">
	<div class="row">
		<div class="col-12">
			<div class="maag-result-area p-3 mt-5 mb-5" style="background-color: #eedaff; border-color: #f4e7ff">
				<div class="maag-result-image-area d-flex justify-content-center">
					<img src="{{ asset('assets/img/maag-kronik.png') }}" class="" alt="">
				</div>

				<div class="maag-result-title-area">
					<h4 style="color: #4a4a4a" class="text-center">Kamu menderita</h4>
					<h2 style="color: #42007c
" class="text-center mb-3">Sakit Maag Kronik</h2>
