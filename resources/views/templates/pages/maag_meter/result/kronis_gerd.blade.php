		...
		<div class="container">
			<div class="row">
				<div class="col-12 d-flex justify-content-center">
					<h3 class="title-about my-5 text-uppercase" style="color: #036242">
						Result
					</h3>
				</div>
			</div>
...
<div class="container">
	<div class="row">
		<div class="col-12">
			<div class="maag-result-area p-3 mt-5 mb-5" style="background-color: #dbe9e4; border-color: #dfefea">
				<div class="maag-result-image-area d-flex justify-content-center">
					<img src="{{ asset('assets/img/kronis-gerd.png') }}" class="" alt="">
				</div>

				<div class="maag-result-title-area">
					<h4 style="color: #4a4a4a" class="text-center">Kamu menderita</h4>
					<h2 style="color: #036242" class="text-center mb-3">Sakit Maag kronis yang disertai GERD</h2>
					<div class="line-dotted mb-3"></div>
				</div>

				<div class="maag-result-content-area">
					<p>Sakit maag kronis yang disebabkan GERD disebabkan oleh pola makan dan gaya hidup kamu, yaitu :</p>

					<div class="maag-result-list-area pt-3 pb-2 pr-3 mb-3" style="background: #ECF3F0">
						<ul>
					...
					<p>Sakit maag Kronik bila tidak segera ditangani akan menganggu aktivitas sehari-hari bahkan bisa menyebabkan penyakit yang lebih parah contohnya kanker. Kondisi GERD dapat menyebabkan luka pada kerongkongan akibat tingginya derajat keasaman dari asam lambung yang naik tersebut dan juga bisa menyebabkan kanker.</p>
