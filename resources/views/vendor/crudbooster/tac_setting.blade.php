    ...
    @push('bottom')
        ...
        <script>
            ...
            var editor_config = {
                ...
                toolbar: "insertfile undo redo | styleselect | bold italic forecolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media",
                relative_urls: false,
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method='post' id="form" enctype="multipart/form-data" action='{{CRUDBooster::mainpath("save-setting?group_setting=$page_title")}}'>
                    ...
                    <div class="box-body">
                        <?php
                        $set = DB::table('cms_settings')->where('group_setting', $page_title)->orderBy('name','desc')->get();
                        foreach($set as $s):
