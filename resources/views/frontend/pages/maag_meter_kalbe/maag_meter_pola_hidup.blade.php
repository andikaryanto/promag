                    ...
                    <div class="col-md-6 pt-2 px-md-5">
                        ...
                        {!! csrf_field() !!}
                            ...
                            <div class="form-group w-100 float-left text-center mt-5 mb-5">
                                <a href="{{url('maag-meter-kalbe/diet')}}"><button type="button" class="btn btn-start p-2 cl-white text-center"><img class="pl-1" src="{{asset('assets/img/left-arrow.png')}}"/> Back</button></a>
