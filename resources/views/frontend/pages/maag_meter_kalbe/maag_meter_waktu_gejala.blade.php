...
<div class="container mt-5" id="symptomtime">
    <div class="row">
    ...
    <div class="row shadow-box">
        <div class="col-12 box-form  mb-4">
            ...
            {!! csrf_field() !!}
                @if ($data->Symptoms)
                    @php
                        $symptomtime = session('symptomtime') ? session('symptomtime') : array();
                        $value = count($symptomtime)>0 ? $symptomtime[$data->id] : '';
                    @endphp
                    <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                <div class="w-100 waktu-gejala mt-1 mb-1">
                                    <label class="container-checkmark label-form-checkout">
                                        <input type="radio" {{ $value =='' && $loop->index == 0 ? 'checked' : '' }}  value="{{ $s->id }}"  {{ $value == $s->id ? 'checked' : '' }}  name="ST[{{ $data->id }}]">
                                        ...
                                        <div class="bx-img-gejala d-flex justify-content-start align-items-center">
                                            ...
                                            <div class="label-meter pl-4">{{ $s->symptom }}</div>
                                        </div>
                ...
                <div class="form-group w-100 float-left text-center mt-5 mb-5">
                    <a href="{{url('maag-meter-kalbe/symptom')}}"><button type="button" class="btn btn-start p-2 cl-white text-center"><img class="pl-1" src="{{asset('assets/img/left-arrow.png')}}"/> Back</button></a>
