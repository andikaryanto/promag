            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="col-12 text-center mt-5 mb-5">
                        <a href="{{url('maag-meter/lifestyle')}}"><button type="button" class="btn btn-start p-2 cl-white text-center"><img class="pl-1" src="{{asset('assets/img/left-arrow.png')}}"/> Back</button></a>
