		...
		<div class="container">
			<div class="row">
				<div class="col-12 mt-4 mb-4">
					<a href="{{ url('seputar-maag/list') }}" class="back-to" title="">< Back to article list</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 artikel-detail">
				...
				<div class="tagcloud01 mb-3">
					...
					<ul>
						@foreach ($tags as $key => $tag )
							<li><a href="{{ url('seputar-maag/list')."?tag=".$tag }}">{{ $tag }}</a></li>
						@endforeach
				...
				<div class="social-share pb-2 mb-5">
					<ul class="list-inline a2a_kit a2a_kit_size_32 " data-a2a-url="{{ url('seputar-maag/detail/'.$detail->slug) }}">
						...
						<li class="list-inline-item">
							<a href="#" title="" class="a2a_button_line">
								<img src="{{ asset('assets/img/logo-line.png') }}" class="w-100" alt="">
							</a>
						</li>
						<li class="list-inline-item">
							<a href="#" title="" class="a2a_button_whatsapp">
				...
				<a href="{{ url('article/detail/'.$article->slug) }}">
					<div class="row artikel-terkait mb-3">
						...
						<div class="col-7">
							...
							<div class="article-excerpt d-none">
								{!! $article->description !!}
							</div>
						</div>
						<div class="col-12">
