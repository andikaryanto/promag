		...
		<div class="container">
			<div class="row">
				<div class="col-12 mt-4 mb-4">
					<a href="{{ url('seputar-maag/fact/list') }}" class="back-to" title="">< Back to article list</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 artikel-detail">
				...
				<div class="social-share pb-2 mb-5">
					<ul class="list-inline a2a_kit a2a_kit_size_32 " data-a2a-url="{{ url('seputar-maag/fact/detail/'.$detail->slug) }}">
